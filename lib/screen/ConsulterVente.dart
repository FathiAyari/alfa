...
import 'package:flutter_application_1/screen/JournalSortie.dart';

class ConsulterVente extends StatefulWidget {
  @override
  _ConsulterVenteState createState() => _ConsulterVenteState();
}

class _ConsulterVenteState extends State<ConsulterVente> {
                          ...
                          onPressed: () {
                            if (_formKey.currentState!.validate()) {
                              ...
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => ModifierVente()),
                              );
                            }

                            // Ajoutez ici la logique pour supprimer les données
                            // en utilisant l'index ou l'ID approprié.
                          },
                        ),
                        ElevatedButton(
                          ...
                          onPressed: () {
                            ...
                            const Icon(Icons.delete_outline,
                                color: Colors.green);
                            // Ajoutez ici la logique pour modifier les données
                            // en utilisant l'index ou l'ID approprié.
                          },
                        ),
                      ],
